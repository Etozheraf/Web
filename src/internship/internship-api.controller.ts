...
export class InternshipApiController {
  ...
  @ApiResponse({ status: 201, description: 'The internship has been successfully created.', type: Internship })
  ...
  @Get()
  @ApiOperation({ summary: 'Get all internships, optionally filtered by category' })
  @ApiQuery({ name: 'category', required: true, type: String, description: 'Filter internships by category name' })
  @ApiResponse({ status: 200, description: 'Return all internships.', type: [Internship] })
  @ApiResponse({ status: 400, description: 'Category is required for finding internships' })
  ...
  @ApiParam({ name: 'uuid', type: 'string', description: 'The uuid of the internship', required: true })
  @ApiResponse({ status: 200, description: 'Return the internship.', type: Internship })
  ...
  @ApiResponse({ status: 200, description: 'The internship has been successfully updated.', type: Internship })
  @ApiResponse({ status: 404, description: 'Internship not found.' })
